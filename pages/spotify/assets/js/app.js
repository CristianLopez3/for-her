document.addEventListener('DOMContentLoaded', function () {
    ...
    const playlist = [
        {
            ...
            src: "./assets/mp3/sick-love.mp3",
            cover: "./assets/img/us.png"
        },
        {
            title: "Tip Toe",
            artist: "HYBS",
            src: "./assets/mp3/tip-toe.mp3", // Replace with actual song URL
            cover: "./assets/img/her.png"
        },
          {
            title: "The fate of Ophelia",
            artist: "Taylor Swift",
            src: "./assets/mp3/the-fate-of-ophelia.mp3", // Replace with actual song URL
            cover: "./assets/img/ophelia.jpg"
        }
    ];
    ...
    const carouselData = [
        ...
        {
            title: "Porque se que amas a Taylor",
            text: "Quiero que me mandas un mensaje, diciendome que leiste esto, para saber que te tomaste el tiempo de leerlo y que sepas que no fue solo devolver lo anterior si no que quiero que sepas que me importa mucho añadirle valor a todo lo que hago para ti, y que cada detalle que tengo contigo es porque te amo y quiero verte feliz."
        }
